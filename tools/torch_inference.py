...
def get_parser() -> ArgumentParser:
    ...
    parser.add_argument("--weights", type=Path, default='./weights/model.pt', required=False, help="Path to model weights")
    parser.add_argument("--input", type=Path, default='./tools', required=False, help="Path to an image to infer.")
    parser.add_argument("--output", type=Path, default='./tools/results', required=False, help="Path to save the output image.")
    parser.add_argument(
        "--device",
        type=str,
        required=False,
